...
<head>
    ...
    <title>@yield('title', 'SPK Cafe - Rekomendasi Cafe Ideal') | SAW Method</title>
            ...
            <div class="flex items-center justify-between h-20">
                <a href="{{ route('cafe.index') }}" class="flex items-center gap-4 group" id="nav-brand">
                    ...
                    <div>
                        ...
                        <span class="block text-[10px] text-black font-bold mt-1 tracking-widest uppercase bg-[#fbbf24] px-1 border border-black inline-block">SAW Method</span>
                    </div>
                </a>
                <div class="flex items-center gap-4">
                    <a href="{{ route('cafe.index') }}" class="px-4 py-2 text-sm font-bold text-black border-2 border-transparent hover:border-black hover:bg-[#fbbf24] transition-colors rounded-none" id="nav-ranking">
                        [ RANKING ]
                    </a>
    ...
    <footer class="mt-16 bg-white border-t-4 border-black">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm font-bold text-black">
                <p>© {{ date('Y') }} <span class="font-retro text-xs bg-[#fbbf24] px-2 py-1 border border-black">SPK CAFE</span> — METODE SAW</p>
